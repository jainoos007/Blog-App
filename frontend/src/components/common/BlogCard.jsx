...
const BlogCard = ({ blog }) => {
  return (
    <div
      key={blog._id}
      className="w-80 h-full min-h-[500px] flex flex-col justify-between overflow-hidden rounded-xl bg-white shadow-lg transition-all duration-300 hover:shadow-xl hover:translate-y-[-5px]"
    >
      {/* Image section */}
